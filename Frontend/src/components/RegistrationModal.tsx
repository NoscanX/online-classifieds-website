...
import {RegistrationTypes, USER_ROLE, RegistrationValidationTypes} from "../types/AuthorizationTypes";
...
const RegistrationModal = (props:any) => {
  ...
  const [registerValues,setRegisterValues] = useState<RegistrationTypes>(initialRegisterValues);
  const handleRegistrationSubmit = async (event:any) => {
    ...
    const data = await RegisterService.saveUser(registerValues);
        ...
        <Modal.Body>
          <Form noValidate validated={validatedRegistration} onSubmit={handleRegistrationSubmit}>
            <Form.Group className="mb-3" controlId="registrationEmailInput">
              ...
              <Form.Control required type="email" placeholder="name@example.com" value={registerValues.email}
                            onChange={(e) => {
            ...
            <Form.Group className="mb-3" controlId="registrationPasswordInput">
              ...
              <Form.Control required type="password" placeholder="Hasło" value={registerValues.password}
                            onChange={(e) => {
                              setRegisterValues((prevState) => ({
                                ...prevState,
            ...
            <Form.Group className="mb-3" controlId="registrationNameInput">
              ...
              <Form.Control required type="text" placeholder="Imię" value={registerValues.name}
                            onChange={(e) => {
                              setRegisterValues((prevState) => ({
                                ...prevState,
                                name: e.target.value,
